...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # A: Inject takes the supplied argument as a variable (initialised to its value) and performs an operation
    # within the block, with each element of the array. The resulting value after each operation is stored in the
    # variable and used for the next operation. The variable is then returned after the last operation.
  end
  ...
  # A: When you use the block syntax for opening a file, Ruby will automatically handle closing the file when the work
