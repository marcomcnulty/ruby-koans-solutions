...
class AboutClasses < Neo::Koan
  ...
  def test_args_to_new_must_match_initialize
    ...
    # A: By writing an initialize method, you ensure that when an object instance is instantiated, it is done with the
    # correct number of arguments. You can also ensure the correct type is used within the method. If an ob&ct isn't
    # correctly initialised then unexpected behaviour could occur.
  end
