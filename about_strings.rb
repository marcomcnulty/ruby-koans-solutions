...
# TIL:
# - Flexible quoting with custom delimiters: '(', '!', '{'
# - Single quoted strings interpret backslashes literally, unless to escape another single quote
#
# - Flexible quotes can handle multiple lines, they DO consider the new line before the last delimeter
...
#
# - Assigning a variable to an object, then another to same object -> they both hold reference to same object. Modifying
#   object will alter the value of both.
#
...
It was the worst of times.
  ...
  def test_the_shovel_operator_modifies_the_original_string
    ...
    # A: << modifies the string in place, appending new content to the existing string object without creating a new
    # object.
    # += creates a new string object each time, allocating new memory and copying the contents of both strings to this new
    # object.
  end
